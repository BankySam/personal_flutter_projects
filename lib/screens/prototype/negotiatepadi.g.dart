...
class Negotiatepadi extends StatefulWidget {
  const Negotiatepadi({Key? key}) : super(key: key);
  @override
  _Negotiatepadi createState() => _Negotiatepadi();
}

class _Negotiatepadi extends State<Negotiatepadi> {
  _Negotiatepadi();
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return Rectangle19(
              ...
              ovrEllipse438: Image.asset(
                'assets/images/I479_968;443_117.png',
                package: 'parabeac',
