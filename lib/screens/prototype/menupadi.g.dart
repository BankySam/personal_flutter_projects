...
class Menupadi extends StatefulWidget {
  const Menupadi({Key? key}) : super(key: key);
  @override
  _Menupadi createState() => _Menupadi();
}

class _Menupadi extends State<Menupadi> {
  _Menupadi();
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Stack(children: [
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.733,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 1.097,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 1.103,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.881,
          width: MediaQuery.of(context).size.width * 0.539,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.936,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 1.353,
          width: MediaQuery.of(context).size.width * 0.028,
          top: MediaQuery.of(context).size.height * 1.477,
          height: MediaQuery.of(context).size.height * 0.024,
          child: Image.asset(
            'assets/images/479_557.png',
            package: 'parabeac',
            width: MediaQuery.of(context).size.width * 0.028,
            height: MediaQuery.of(context).size.height * 0.024,
            fit: BoxFit.fill,
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.889,
