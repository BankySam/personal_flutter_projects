...
class Support2 extends StatefulWidget {
  ...
  @override
  _Support2 createState() => _Support2();
}

class _Support2 extends State<Support2> {
  _Support2();
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Stack(children: [
        ...
        Positioned(
          left: MediaQuery.of(context).size.width * 0.286,
        ...
        Positioned(
          ...
          top: MediaQuery.of(context).size.height * 0.681,
          height: MediaQuery.of(context).size.height * 0.07,
          child: Container(
            width: MediaQuery.of(context).size.width * 1.156,
            height: MediaQuery.of(context).size.height * 0.070,
        ...
        Positioned(
          ...
          top: MediaQuery.of(context).size.height * 0.761,
          height: MediaQuery.of(context).size.height * 0.07,
          child: Container(
            width: MediaQuery.of(context).size.width * 1.136,
            height: MediaQuery.of(context).size.height * 0.070,
        ...
        Positioned(
          ...
          top: MediaQuery.of(context).size.height * 0.198,
