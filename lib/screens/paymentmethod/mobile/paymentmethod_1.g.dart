...
class Paymentmethod1 extends StatefulWidget {
  ...
  @override
  _Paymentmethod1 createState() => _Paymentmethod1();
}

class _Paymentmethod1 extends State<Paymentmethod1> {
  _Paymentmethod1();
